...
urlpatterns = [
    ...
    path('api/embarques/search_cliente', views.SearchCliente.as_view(), name='search_cliente'),
    ...
    path('api/embarques/get_envios_pendientes_cliente/', views.get_envios_pendientes_cliente, name='get_envios_pendientes_cliente'),
