...
class Envio(models.Model):
    id = models.BigAutoField(primary_key=True)
    embarque_id = models.BigIntegerField()
    ...
    arribo_latitud = models.DecimalField(max_digits=19, decimal_places=7)
    arribo_longitud = models.DecimalField(max_digits=19, decimal_places=7)
    recepcion = models.DateTimeField(blank=True, null=True)
    recepcion_latitud = models.DecimalField(max_digits=19, decimal_places=7)
